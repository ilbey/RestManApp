...
public class ResManApp {
    ...
    /**
     * doing serialization and writing objects to TXT File as named "out.txt".
     */
    ...
    /**
     * Takes data from "out.txt" and hashes and writes data to MD5File by using MD5 algorithm.
     */
    public static void toMd5File() {
        FileInputStream fis = null;
        try {
            fis = new FileInputStream("out.txt");
            BufferedInputStream bis = new BufferedInputStream(fis);
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            FileOutputStream fos = new FileOutputStream("md5.txt");
            ...
            out.writeObject(hexString.toString());
    ...
    /**
     * Takes data from MD5File which has been hashed by ResManApp.toMD5File() as using MD5, takes data from "out.txt"
     * and converts it, finally compares these two.
     */
    public static void fromMd5File() {
        FileInputStream fis = null;
        try {
            fis = new FileInputStream("md5.txt");
            ...
            System.out.println("OUT File: " + (hexString.toString()));

            if (md5.equals(hexString.toString())) {
                JOptionPane.showMessageDialog(null, "The files have been checked. System is safe!", "Success!", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Please be careful, the system was detected security vulnerability!", "Warning!", JOptionPane.ERROR_MESSAGE);
            }
